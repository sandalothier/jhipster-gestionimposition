...
@RestController
@RequestMapping("/api/gestionimposition-kafka")
public class GestionimpositionKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GestionimpositionKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GestionimpositionKafkaResource(KafkaProperties kafkaProperties) {
