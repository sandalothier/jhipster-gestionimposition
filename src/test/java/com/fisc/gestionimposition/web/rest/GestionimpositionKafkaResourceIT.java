package com.fisc.gestionimposition.web.rest;

import com.fisc.gestionimposition.config.KafkaProperties;
...
class GestionimpositionKafkaResourceIT {
    ...
    void setup() {
        ...
        GestionimpositionKafkaResource kafkaResource = new GestionimpositionKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/gestionimposition-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/gestionimposition-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
